...
<!-- Mirrored from www.krakatausteel.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Jan 2021 03:17:50 GMT -->
...
<head>
    ...
    <link rel="stylesheet" href="{{url(url_linknya.'/web/css/bootstrap-grid.css')}}">
    <link rel="stylesheet" href="{{url(url_linknya.'/web/css/style.css')}}">
    <link rel="stylesheet" href="{{url(url_linknya.'/web/css/glide.css')}}">
    <link rel="stylesheet" href="{{url(url_linknya.'/web/css/magnific-popup.css')}}">
    <link rel="stylesheet" href="{{url(url_linknya.'/web/css/content-box.css')}}">
    <link rel="stylesheet" href="{{url(url_linknya.'/web/css/media-box.css')}}">
    <link rel="stylesheet" href="{{url(url_linknya.'/web/css/contact-form.css')}}">
    <link rel="stylesheet" href="{{url(url_linknya.'/web/skin.css')}}">
    <link rel="icon" href="{{url(url_linknya.'/web/images/fav.png')}}">
    		<!-- CSS STYLE-->
    <link rel="stylesheet" type="text/css" href="{{url(url_linknya.'/web/rs-plugin/css/style.css')}}" media="screen" />
    <link rel="stylesheet" type="text/css" href="{{url(url_linknya.'/web/rs-plugin/css/settings.css')}}" media="screen" />
	<body>
        ...
        <div class="container">
            ...
            <div class="menu-cnt">
                ...
                <div class="menu-right">
                    ...
                    <ul class="lan-menu">
                        <li class="dropdown">
                                                        <a href="#"><img src="web/images/id.png" alt="lang" />ID </a>
                                                        <ul>
                                <li><a href="index.html"><img src="web/images/id.png" alt="lang" />ID</a></li>
                                <li><a href="index.html"><img src="web/images/en.png" alt="lang" />EN</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
		...
		<div class="tp-banner" >
			<ul class="tp-revslider-mainul" style="visibility: visible; display: block; overflow: hidden; width: 100%; height: 100%; max-height: none;">	<!-- SLIDE  -->
				<!-- SLIDE  -->
					...
					<!-- MAIN IMAGE -->
					<img src="web/images/slide/hrc.jpg"  alt="newslide2014_1"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
					<!-- LAYERS -->
					...
					<div class="tp-caption finewide_verysmall_white_mw customin customout tp-resizeme"
						...
						style="z-index: 10; max-width: auto; max-height: auto; white-space: nowrap;">Build the Nation with the Best Quality of Steel
								...
								<li data-transition="fade" data-slotamount="7" data-masterspeed="1000" data-delay="13000" >
					<!-- MAIN IMAGE -->
					<img src="web/images/slide/crc.jpg"  alt="newslide2014_1"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
					<!-- LAYERS -->
					...
					<div class="tp-caption finewide_verysmall_white_mw customin customout tp-resizeme"
						...
						style="z-index: 10; max-width: auto; max-height: auto; white-space: nowrap;">We Provide Steel for your specific needs
								...
								<li data-transition="fade" data-slotamount="7" data-masterspeed="1000" data-delay="13000" >
					<!-- MAIN IMAGE -->
					<img src="web/images/slide/wirerod.jpg"  alt="newslide2014_1"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
					<!-- LAYERS -->
					...
					<div class="tp-caption finewide_verysmall_white_mw customin customout tp-resizeme"
						...
						style="z-index: 10; max-width: auto; max-height: auto; white-space: nowrap;">Towards a better tomorrow
								...
								<li data-transition="fade" data-slotamount="7" data-masterspeed="1000" data-delay="13000" >
					<!-- MAIN IMAGE -->
					<img src="web/images/slide/downstream.jpg"  alt="newslide2014_1"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
					<!-- LAYERS -->
					...
					<div class="tp-caption finewide_verysmall_white_mw customin customout tp-resizeme"
						...
						style="z-index: 10; max-width: auto; max-height: auto; white-space: nowrap;">We Innovate by Growing together with the Industry
								...
								<li data-transition="fade" data-slotamount="7" data-masterspeed="1000" data-delay="13000" >
					<!-- MAIN IMAGE -->
					<img src="web/images/slide/calibration.jpg"  alt="newslide2014_1"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
					<!-- LAYERS -->
                ...
                <div class="grid-list" data-columns="3" data-columns-md="2" data-columns-sm="1">
                    <div class="grid-box">
                            ...
                            <div class="cnt-box cnt-box-top-icon boxed">
                                <i class="im-monitor-phone"><img src="web/images/progressif.png"></i>
                                <div class="caption">
                                    <h2>
                                                                                    Progresif
                                                                            </h2>
                                    <p>
                                                                                    Kami hadir sebagai perusahaan yang inovatif, bergerak beriringan dengan industri, serta mampu menghadapi dengan siap segala tantangan yang ada di industri
                                                ...
                                                <div class="grid-item">
                            <div class="cnt-box cnt-box-top-icon boxed">
                                <i class="im-monitor-phone"><img src="web/images/colaboratif.png"></i>
                                <div class="caption">
                                    <h2>
                                                                                    Kolaboratif
                                                                            </h2>
                                    <p>
                                                                                    Kami akan tetap memegang teguh komitmennya sebagai seorang “rekan”, seorang “partner terpercaya” dan saling menumbuhkembangkan satu sama lain.
                                                ...
                                                <div class="grid-item">
                            <div class="cnt-box cnt-box-top-icon boxed">
                                <i class="im-monitor-phone"><img src="web/images/robust.png"></i>
                                <div class="caption">
                                    <h2>
                                                                                    Tangguh	
                                                                            </h2>
                                    <p>
                                                                                    Dengan semangatnya yang baru, PT Krakatau Steel (Persero) Tbk akan tetap hadir di tengah masyarakat sebagai perusahaan besar didukung dengan infrastruktur yang mumpuni dan mampu memimpin industri.
                        ...
                        <ul class="slider" data-options="arrows:true,nav:false">
                            ...
                            <li>
                                <a class="img-box img-box-caption btn-video lightbox" href="https://www.youtube.com/watch?v=6TR9EZzpm7o" data-lightbox-anima="fade-top">
                                    <img src="web/images/newlogo.jpg" alt="">
                                    <span>
                            ...
                            <li>
                                <a class="img-box img-box-caption btn-video lightbox" href="https://www.youtube.com/watch?v=ZYZOFRA7NhI" data-lightbox-anima="fade-top">
                                    <img src="web/images/ksuntung.jpg" alt="">
                                    <span>
                            ...
                            <div class="grid-item">
                                <div class="cnt-box cnt-box-blog-top" data-href="viewnews/2410.html">
                                    <a href="#" class="img-box">
                                        ...
                                        <img src="web/images/news/semangatbaru.jpg" alt="" />
                                    </a>
                                    <div class="caption">
                            ...
                            <div class="grid-item">
                                <div class="cnt-box cnt-box-blog-top" data-href="viewnews/2409.html">
                                    <a href="#" class="img-box">
                                        ...
                                        <img src="web/images/news/newsbaru-01.jpg" alt="" />
                                    </a>
                                    <div class="caption">
                            ...
                            <div class="grid-item">
                                <div class="cnt-box cnt-box-blog-top" data-href="viewnews/2408.html">
                                    <a href="#" class="img-box">
                                        ...
                                        <img src="web/images/news/news1-01.jpg" alt="" />
                                    </a>
                                    <div class="caption">
        ...
        <section class="section-base">
            <div class="container">
                <div class="row align-items-center" data-anima="fade-bottom" data-time="1000">
                    <div class="col-lg-6">
                        <img src="web/images/calibration-pic-blue-005.jpg" alt="" />
                    </div>
                    <div class="col-lg-6">
                        <div class="title">
                ...
                <div class="row align-items-center" data-anima="fade-bottom" data-time="1000">
                    ...
                    <div class="col-lg-6">
                        <img src="web/images/krasmart.png" alt="" />
                    </div>
                </div>
            </div>
        </section>
    ...
    <div class="container">
        ...
        <script src="web/scripts/glide.min.js"></script>
        <script src="web/scripts/imagesloaded.min.js"></script>
        <script src="web/scripts/custom.js"></script>
        <script src="web/scripts/progress.js"></script>
        <script src="web/scripts/tab-accordion.js"></script>
        <script src="web/scripts/magnific-popup.min.js"></script>
        <script src="web/scripts/contact-form/contact-form.js"></script>
        	<!-- SLIDER REVOLUTION 4.x SCRIPTS  -->
    <script type="text/javascript" src="web/rs-plugin/js/jquery.themepunch.plugins.min.js"></script>
...
<!-- Mirrored from www.krakatausteel.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Jan 2021 03:19:15 GMT -->
</html>